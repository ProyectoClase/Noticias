                ...
                <form action="insertar_noticias.php" method="post">
                    ...
                    <div class="row">
                        <div class="form-group col-sm-5 col-md-5 col-vmd-5 col-lg-5 col-vlg-5  col-lg-offset-1 col-vlg-offset-0">
                            ...
                            <button class="btn btn-success btn-sm" type="submit" name="enviar">
                ...
                <table class="tablesorter">
                    ...
                    <tbody>
                        <?php
                            ...
                            try {
                                $con = conectar();
                                if(es_administrador($_SESSION['usuario']) == 1){
                                    $consulta = "SELECT id, titulo,fecha_inicio, fecha_fin, usuarios_login from noticias";
                                }
                                else{
                                    $consulta = "SELECT id, titulo,fecha_inicio, fecha_fin, usuarios_login from noticias where usuario_login = '".$_SESSION['usuario']."'";
                                }
